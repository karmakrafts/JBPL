...
public final class LocalDefineResetVisitor implements ElementVisitor {
    public static final LocalDefineResetVisitor INSTANCE = new LocalDefineResetVisitor();

    private LocalDefineResetVisitor() {
    }
