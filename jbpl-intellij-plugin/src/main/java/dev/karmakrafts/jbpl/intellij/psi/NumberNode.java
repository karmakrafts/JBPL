...
public final class NumberNode extends ANTLRPsiNode implements Annotated {
    public NumberNode(final @NotNull ASTNode node) {
        super(node);
    }
    ...
    public void annotate(final @NotNull AnnotationHolder holder) { // @formatter:off
        holder.newSilentAnnotation(HighlightSeverity.TEXT_ATTRIBUTES)
            .range(this)
            .textAttributes(TextAttributeKeys.NUMBER)
            .create();
    } // @formatter:on
}
