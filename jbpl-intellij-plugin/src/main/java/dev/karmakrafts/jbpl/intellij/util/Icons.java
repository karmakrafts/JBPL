...
public final class Icons {
    ...
    public static final Icon YEET = IconLoader.getIcon("/icons/dev/karmakrafts/jbpl/intellij/yeet.svg", Icons.class);
    ...
    public static final Icon SELECTOR = IconLoader.getIcon("/icons/dev/karmakrafts/jbpl/intellij/selector.svg",
        Icons.class);
    public static final Icon DEFINE = IconLoader.getIcon("/icons/dev/karmakrafts/jbpl/intellij/define.svg",
        Icons.class);
    public static final Icon MACRO = IconLoader.getIcon("/icons/dev/karmakrafts/jbpl/intellij/macro.svg", Icons.class);
